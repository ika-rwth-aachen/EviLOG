...
#   - added dropout of 0.5 in Block1, Block2 and Block3
# ==============================================================================
...
def getPointPillarsModel(image_size, max_pillars, max_points, nb_features,
    ...
    for n in range(4):
        ...
        x = tf.keras.layers.BatchNormalization(name="cnn/block1/bn%i" % n,
                                               fused=True)(x)
    x = tf.keras.layers.Dropout(0.5, name="cnn/block1/dropout")(x)
    x1 = x
    ...
    for n in range(6):
        ...
        x = tf.keras.layers.BatchNormalization(name="cnn/block2/bn%i" % n,
                                               fused=True)(x)
    x = tf.keras.layers.Dropout(0.5, name="cnn/block2/dropout")(x)
    x2 = x
    ...
    for n in range(6):
        ...
        x = tf.keras.layers.BatchNormalization(name="cnn/block3/bn%i" % n,
                                               fused=True)(x)
    x = tf.keras.layers.Dropout(0.5, name="cnn/block3/dropout")(x)
    x3 = x
